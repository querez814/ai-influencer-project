#!/usr/bin/env python3
"""
generate_character_cuda.py - Script to generate base images for an AI influencer character
with specific features (petite, Caucasian with Asian features, highlighted hair). CUDA version for non-zaki mac usage
"""
...
if not torch.cuda.is_available():
    print("Warning: CUDA not available. This will run very slowly on CPU.")
